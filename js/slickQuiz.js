...
if(window['swal']) { alert = function(options) { return swal(options); }}
        ...
        plugin.method = {
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        questionHTML.append($('<h3></h3>').text(formatQuestion));
                        ...
                        // Get the answers
                        var answers = plugin.config.randomSortAnswers && !question.disable_random ?
                        ...
                        for (i in answers) {
                            if (answers.hasOwnProperty(i)) {
                                ...
                                var answerContent = $('<li></li>')
                                    .append(input)
                                    .append($(optionLabel).text(answer.option));
            ...
            startQuiz: function(options) {
                ...
                if (plugin.config.events &&
                        plugin.config.events.onBeforeStartQuiz) {
                    if (plugin.config.events.onBeforeStartQuiz.apply (null, []) === false) {
                        return false;
                    }
                }
            ...
            checkAnswer: function(checkButton, options) {
                ...
                answerLIs.each(function(i, e) {
                    e.result = incorrectResponseClass;
                });
                ...
                for (i in answers) {
                    if (answers.hasOwnProperty(i)) {
                        ...
                        if (answer.correct) {
                            ...
                            answerLIs.get(index).result = correctResponseClass;
                        }
                    }
                }
                ...
                if (plugin.config.preventUnanswered && selectedAnswers.length === 0) {
                    alert({ title: 'Oops...', text: plugin.config.preventUnansweredText,type: 'error' });
                    return false;
                }
                ...
                if (correctResponse) {
                    ...
                    questionLI.get(0).result = correctClass;
                    questions[questionIndex].result = true;
                } else {
                    //questionLI.addClass(incorrectClass);
                    questionLI.get(0).result = incorrectClass;
                    questions[questionIndex].result = false;
                }
                questions[questionIndex].answer = questions[questionIndex].a.filter(function(e, i) {
                  return selectedAnswers.includes(i);
                }).map(function(e) { return e.option;} ).join(',');
                    ...
                    if (!plugin.config.perQuestionResponseAnswers) {
                        ...
                        questionLI.find(_answers).hide({
                            ...
                            complete: function() {
                                ...
                                questionLI.each(function(i, e) {
                                    e.result = completeClass;
                                });
                            }
                        });
                    } else {
            ...
            completeQuiz: function(options) {
                ...
                var score        = $(_element+ ' li.question').filter(function(i, e) {return (e.result === "correctResponse");}).length,//$(_element + ' ' + _correct).length,
                    displayScore = score;
